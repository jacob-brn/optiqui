  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.h1
          className="w-full max-w-xl px-4 mx-auto text-4xl md:text-5xl lg:text-6xl 2xl:text-7xl font-semibold text-center text-balance dark:text-foreground text-background tracking-tight"

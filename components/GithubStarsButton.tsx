...
const GithubStarsButton = async () => {
  ...
  return (
    <Link
      ...
      target="_blank"
      className="group hidden md:flex flex-row items-center justify-center gap-x-2 bg-gradient-to-t from-neutral-800 via-neutral-900 to-neutral-950 text-white rounded-md px-5 py-2 border"
    >
